      ...
      <div className="max-w-7xl mx-auto px-6 py-12 grid grid-cols-1 md:grid-cols-3 gap-10">
        ...
        <div className="grid grid-cols-2 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              <li>
                <Link href="/Costumer/detailfotography" className="hover:text-blue-400 transition-colors">
                  Fotografi
                </Link>
              </li>
              <li>
                <Link href="/Costumer/detailvideography" className="hover:text-blue-400 transition-colors">
                  Videografi
                </Link>
              </li>
              <li>
                <Link href="/Costumer/delayanimasi" className="hover:text-blue-400 transition-colors">
                  Animasi
                </Link>
              </li>
              <li>
                <Link href="/Costumer/delaybroadcasting" className="hover:text-blue-400 transition-colors">
                  Broadcasting
                </Link>
              </li>
              <li>
                <Link href="/Costumer/detailgame" className="hover:text-blue-400 transition-colors">
                  Game
                </Link>
              </li>
              <li>
                <Link href="/Costumer/delaydesign" className="hover:text-blue-400 transition-colors">
                  Design
                </Link>
              </li>
              <li>
                <Link href="/Costumer/detailsound" className="hover:text-blue-400 transition-colors">
                  Sound Production
                </Link>
              </li>
              <li>
                <Link href="/Costumer/detailsewa" className="hover:text-blue-400 transition-colors">
                  Sewa Barang
                </Link>
              </li>
            </ul>
