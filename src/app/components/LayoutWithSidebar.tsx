...
export default function LayoutWithSidebar({
  ...
  const layananMenu = [
    { href: "/layanan/photography", label: "Photography", icon: <Camera size={16} /> },
    { href: "/layanan/videography", label: "Videography", icon: <Video size={16} /> },
    { href: "/layanan/design", label: "Design", icon: <Brush size={16} /> },
    { href: "/layanan/animasi", label: "Animasi", icon: <Film size={16} /> },
    { href: "/layanan/game", label: "Game", icon: <Gamepad2 size={16} /> },
    { href: "/layanan/broadcasting", label: "Broadcasting", icon: <Radio size={16} /> },
    { href: "/layanan/soundproduction", label: "Sound Production", icon: <Headphones size={16} /> },
    { href: "/layanan/sewabarang", label: "Sewa Barang", icon: <Package size={16} /> },
  ];
  ...
  const handleLayananClick = () => {
    router.push("/layanan"); // langsung ke halaman layanan utama
