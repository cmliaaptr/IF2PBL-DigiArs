...
export default function SoundproductionPage() {
  const [photos, setPhotos] = useState<PhotoItem[]>([
    { id: 1, photo: "photo1.jpg", title: "Design Thinking" },
    {
      id: 2,
      photo: "photo2.jpg",
      title:
    ...
    { id: 3, photo: "photo3.jpg", title: "Event Design" },
  ]);
  ...
  return (
    <LayoutWithSidebar>
      {/* === HEADER === */}
      <div className="mb-4">
        <h1 className="text-4xl font-bold text-gray-800 mb-3">Sound Production</h1>
        <button
