...
export default function SewabarangPage() {
  const [photos, setPhotos] = useState<PhotoItem[]>([
    { id: 1, photo: "photo1.jpg", title: "Camera Lumi" },
    {
      id: 2,
      photo: "photo2.jpg",
      title:
    ...
    { id: 3, photo: "photo3.jpg", title: "Cineye" },
  ]);
  ...
  return (
    <LayoutWithSidebar>
      {/* === HEADER === */}
      <div className="mb-4">
        <h1 className="text-4xl font-bold text-gray-800 mb-3">Sewa Barang</h1>
        <button
        ...
        <div className="fixed inset-0 bg-black/40 flex justify-center items-center z-50">
          <div className="bg-white rounded-lg p-6 w-[400px] shadow-xl">
            ...
            <form onSubmit={handleSubmit} className="space-y-3">
              ...
              {/* JUDUL */}
              <div>
                <label className="block text-sm text-gray-700 font-medium">Nama Barang</label>
                <input
                  type="text"
